...
export function ExperiencesTable() {
    const elements = [
        { date: "27/3/24", level: "74", participant2: 'itay45977@gmail.com', participant1: 'ohad@gmail.com' },
        { date: "30/3/24", level: "69", participant2: 'nikol@gmail.com', participant1: 'noam@gmail.com' },
        { date: "31/3/24", level: "40", participant2: 'ilan@gmail.com', participant1: 'jecki@gmail.com' }
    ];
